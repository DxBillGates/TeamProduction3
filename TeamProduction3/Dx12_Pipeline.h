...
public:
	Dx12_Pipeline(ID3D12Device* device, Dx12_Shader* pShader, Dx12_RootSignature* pRootSignature, std::vector<InputLayout> inputLayout, BlendMode blendMode = BLENDMODE_ALPHA,D3D12_PRIMITIVE_TOPOLOGY_TYPE topologyType = D3D12_PRIMITIVE_TOPOLOGY_TYPE_TRIANGLE);
	~Dx12_Pipeline();
